...
sed -i '/uci commit system/i\uci set system.@system[0].hostname='OpenWrt-XI'' package/lean/default-settings/files/zzz-default-settings
...
sed -i 's/"服务"/"VPN"/g' package/lean/luci-app-frpc/po/zh-cn/frp.po
